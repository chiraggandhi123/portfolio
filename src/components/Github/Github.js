...
const Github = () => {
  ...
  useEffect(() => {
    fetchGithubStats('chiraggandhi123').then((stats) => setStats(stats));
  }, []);

  useEffect(() => {
    fetchGithubSvg('chiraggandhi123').then((svg) => setSvg(svg.dataset));
  }, []);
  const {
    totalStars,
    totalIssues,
  ...
  return (
    ...
    >
      ...
      <Container>
        ...
        >
          <Figure>
            <Embed src="https://wakatime.com/share/@chiraggandhi123/a750f08f-2404-4f77-8df8-849d0a8f4109.svg" />
          </Figure>
        </WakatimeStats>
